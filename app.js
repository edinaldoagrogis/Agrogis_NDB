...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let offlineSatelliteLayer = L.tileLayer('offline_tiles/{z}/{x}/{y}.jpg', {
        minZoom: 10,
        maxZoom: 19,
        maxNativeZoom: 13, // Must match the max zoom generated by the python script
        zIndex: 0,
        errorTileUrl: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=' // Transparent tile on error
    });
